...
func coupleAPIErrors(r *resty.Response, err error) (*resty.Response, error) {
	...
	if r.Error() != nil {
		...
		// TODO: Add Sitehost Control here
...
// NewError creates a sitehost.Error with a Code identifying the source err type,
...
func NewError(err interface{}) *Error {
	...
	default:
		log.Fatalln("Unsupported type to sitehost.NewError")
		panic(err)
	}
}
