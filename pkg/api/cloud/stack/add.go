...
func (s *Client) AddWithImage(ctx context.Context, request AddRequestWithImage) (response AddResponse, err error) {
	...
	dockerCompose, err := s.GenerateDockerCompose(ctx, GenerateDockerComposeRequest{
		Name:      request.Name,
		Label:     request.Label,
...
func (s *Client) GenerateDockerCompose(ctx context.Context, request GenerateDockerComposeRequest) (dockerCompose string, err error) {
	// Get the image
	...
	compose, err := buildDockerCompose(BuildDockerCompose{
		Name:    request.Name,
		Label:   request.Label,
...
func buildDockerCompose(request BuildDockerCompose) (dockerCompose string, err error) {
